...
public class ProdutoController {
	...
	public ResponseEntity<Produto> salvarProduto(@RequestBody @Valid Produto produto) throws ExceptionMentoriaJava{
		...
		if(produto.getId() == null) {
			...
			if(!produtos.isEmpty()) {
				throw new ExceptionMentoriaJava("Já existe um produto com esse nome. " + produto.getNome());
			}
		}	
	...
	public ResponseEntity<Produto> obterProduto(@PathVariable("id") Long id) throws ExceptionMentoriaJava{ 
		...
		if(produto == null) {
			throw new ExceptionMentoriaJava("Não encontrou o produto com o id: " + id);
		}
	...
	public ResponseEntity<List<Produto>> buscaPorNome(@PathVariable("nome") String nome) { 
